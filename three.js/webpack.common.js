...
module.exports = {
    plugins: [
        // Automatically create an index.html with the right bundle name and references to out javascript.
        new HtmlWebpackPlugin({
            template: 'html/index.html'
        }),
        // Copy game assets from out static directory, to the webpack
        new CopyPlugin({
            patterns: [
